...
//this code was made mainly using what I have learned from first course up to course 4
//tools I used to help me review my code and learn more were
//Google and chatgpt
//I believe that chatgpt, in the right hands and mind, can help you become an engineer
//in the hands of the lazy, they will become code monkey
//the only function that I copied from chatgpt was EnableANSIColors with #define NOMINMAX and #include <windows.h>
//as it turned out other systems wouldn't get text colors because not all command boxes work the same as mine
//even then I had to fix some issues that chatgpt wasn't aware of 
